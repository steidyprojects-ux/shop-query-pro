...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Consulta el estado de movilidad de Claro por cédula y ciudad." },
      { name: "author", content: "Visor Movilidad" },
      ...
      { name: "twitter:site", content: "@VisorMovilidad" },
    ],
    links: [
      {
        rel: "stylesheet",
